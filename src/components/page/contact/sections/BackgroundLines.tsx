    ...
    <div className="top-0 h-screen w-full">
      ...
      <div className="lines green">
        <div className="horizontals">
          ...
          {/* About */}
          {/* <div className="absolute top-[50rem] h-[1px] w-full bg-blue-600"></div>
          <div className="absolute top-[65rem] h-[1px] w-full bg-blue-600"></div>
        ...
        <div className="verticals">
          ...
          {/* LeftMost Side */}
          <div className="absolute left-0 h-[100vh] w-[1px] bg-blue-400"></div>
          <div className="absolute left-5 h-[100vh] w-[1px] bg-blue-400"></div>
          {/* LeftmostSide About */}
          {/* <div className="absolute left-0 top-[100vh] h-[100vh] w-[1px] bg-blue-600"></div>
